...
### 3.3 Phase 4 BFO ARC content fixtures — step-N-bind (AMENDED at Q-4-Step4-A mid-phase architectural-gap micro-cycle 2026-05-11; further AMENDED at Q-4-Step6-A mid-phase architectural-gap micro-cycle 2026-05-14/15)

**Q-4-Step6-A amendment 2026-05-14/15:** the existing `regularity_check_clears_warning` + `regularity_check_keeps_warning` rows (originally listed at Phase 4 entry packet 2026-05-10) are now PATH-FENCE-AUTHORED per Q-4-Step6-A.2 SME dispatch + Q-4-Step6-A.1.1 Sub-option α minimum-viable certification logic (non-transitive chain certification per Horrocks et al. 2007). The two fixtures exercise both sides of the Sub-option α binary outcome ('regularity-certified' affirmative skip-warning + 'cannot-certify' conservative-default keeps-warning); together activate Step 6's deliverable surface.


**Amendment note (Q-4-Step4-A 2026-05-11):** new step-N-bind fixture `bfo_disjointness_map_axiom_emission.fixture.js` added at row 10 per architect Q-4-Step4-A ruling (mid-phase architectural-gap micro-cycle: Phase 4 mid-phase counter increments 0 → 1). Per the corpus-addition-transparency banking (architect Q-4-Step4-A Banking 5 2026-05-11 — symmetric application of the corpus-reduction-transparency discipline): **step-N-bind count 9 → 10 with explicit attribution.** The fixture exercises unit-level emission of pairwise binary FOL axioms from the BFO Disjointness Map loaded via the newly-ratified `disjointnessAxioms` field on `ARCModule` (Q-4-Step4-A Option A schema extension); distinct from `nc_bfo_continuant_occurrent` corpus-before-code sibling (end-to-end consistency-rejection) per the corpus-tagging discipline.
...
| **`bfo_disjointness_map_axiom_emission.fixture.js` (NEW at Q-4-Step4-A 2026-05-11)** | step-N-bind (Step 4) | Pairwise binary universal-implication axioms emitted from `disjointnessAxioms` field per Q-4-Step4-A.1 N-ary expansion ruling; spot-checks binary (Continuant ⊓ Occurrent) + ternary (IC/SDC/GDC) + 4-ary (Occurrent sub-partition) emission shapes; forbidden patterns guard against N-ary single-axiom emission + reverse-ordered duplicate emission | Unit-level emission failure modes: (1) silent drop of disjointness FOL; (2) N-ary single-axiom shape instead of pairwise expansion; (3) reverse-ordered duplicate emission; (4) wrong False-in-head shape |
...
### 3.8 Total Phase 4 corpus (amended at Q-4-C source-state amendment cycle 2026-05-10; further amended at Q-4-Step4-A mid-phase architectural-gap micro-cycle 2026-05-11)
...
- **10 step-N-bind fixtures** (BFO ARC content authoring + strict mode + ARC module loader + regularity check + PROV-O entailment + arity_flattening + **`bfo_disjointness_map_axiom_emission` NEW at Q-4-Step4-A 2026-05-11**)

**Total at Phase 4 close: 59 corpus fixtures + 4 demo cases (A: BFO Disjointness firing; B: Layer A continuation citations per Q-4-C amendment; C: Lossy round-trip exit deliverable; opening: Phase 2 reactivation surface).** Corpus count history per the corpus-shape-transparency banking (Q-4-C amendment reduction banking + Q-4-Step4-A addition banking, symmetric application; extended at Q-4-Step6-A):

| Cycle | Δ | Total | Attribution |
|---|---|---|---|
| Phase 4 entry packet initial DRAFT 2026-05-10 | +14 (6 cb-c + 9 step-N-bind = 15 minus Q-4-E pull on `nc_sdc_gdc` = 14 Phase 4 active) | 43 + 14 = 57 | Q-4-B + Q-4-E rulings |
| Q-4-C source-state amendment cycle 2026-05-10 | −1 (`p4_bfo_clif_layer_b` pulled per §8.2 contingency → Phase 5 forward-track) | 57 → 56 | Q-4-C Ruling 2; corpus-reduction-transparency banking |
| Q-4-Step4-A mid-phase architectural-gap micro-cycle 2026-05-11 | +1 (`bfo_disjointness_map_axiom_emission` NEW step-N-bind per architect Required-of-the-fixture-addition) | 56 → 57 | Q-4-Step4-A Banking 5 corpus-addition-transparency (symmetric application of corpus-reduction-transparency banking) |
| Q-4-Step6-A mid-phase architectural-gap micro-cycle 2026-05-14/15 | +2 (`regularity_check_clears_warning` + `regularity_check_keeps_warning` NEW step-N-bind per Q-4-Step6-A.2 SME dispatch + Q-4-Step6-A.1.1 Sub-option α two-sided binary-outcome coverage) | 57 → 59 | Q-4-Step6-A.2 SME dispatch APPROVED; corpus-addition-transparency symmetric application |

**Net at Q-4-Step6-A 2026-05-14/15: 59 corpus fixtures (43 inherited + 4 corpus-before-code + 12 step-N-bind).** Layer B parity demonstration forward-tracked to Phase 5; Disjointness Map emission unit-level verification + regularityCheck affirmative + conservative emission unit-level verification added per Q-4-Step4-A + Q-4-Step6-A bindings.
...
- **Phase 4 contingency-operationalization sub-cycle counter (NEW at Q-4-C source-state amendment cycle 2026-05-10 per Ruling 4 framing):** at **1** (Q-4-C source-state amendment cycle 2026-05-10 — first production operationalization of a ratified contingency framing in the project's cycle history); **brief confirmation cycle 2026-05-10 closes the sub-cycle** per architect Q-4-C amendment brief confirmation 2026-05-10; closure formalizes when Pass 2a commit lands + remote CI green (landed at commit `1f2cff6` 2026-05-10). Brief confirmation cycle does NOT increment any counter per the architect-banked principle "brief follow-up confirmation cycles for path-fence-authored amendments whose substance was ratified at the prior cycle do not increment cycle-cadence counters" (Phase 3 entry-packet final-ratification cycle banking 2026-05-08; reaffirmed at Q-4-C amendment brief confirmation 2026-05-10). Distinct from the stakeholder-routing corrective sub-cycle bucket; distinct from the entry-cycle counter; per architect Ruling 4: *"Corrective sub-cycles (architect-error-correction) and contingency-operationalization sub-cycles (pre-ratified contingency triggering on evidence) are different bucket categories."*
- **Phase 4 mid-phase architectural-gap counter:** at **3** (Q-4-Step4-A first instance 2026-05-11 + Q-4-Step5-A second instance 2026-05-14 + **Q-4-Step6-A third instance 2026-05-14/15 — HITS Q-4-A ~3 PROJECTION EXACT MATCH**). **Q-4-Step4-A** closed at Pass 2b brief confirmation 2026-05-14; formalized at commit `427eff5`. **Q-4-Step5-A Pass 2b brief confirmation cycle 2026-05-14 closes the sub-cycle**; closure formalizes when Pass 2b commit lands + remote CI green. **Q-4-Step6-A open at this cycle** (architect ruling closed 2026-05-14/15; SME path-fence-author opens; closure formalizes when Pass 2b commit lands + remote CI green per architect-ratified sequencing). Brief confirmation cycles do NOT increment any counter per the architect-banked principle on brief follow-up confirmation cycles. Distinct from contingency-operationalization sub-cycle bucket (Q-4-C); distinct from stakeholder-routing corrective sub-cycle bucket.

**Tight projection-match data point (per Q-4-Step6-A architect ruling 2026-05-14/15 + Q-4-Step6-A Pass 2b brief confirmation Banking 4 projection-match data-point preservation banking 2026-05-14/15):** Phase 4 substantive-scope-weighting projection at entry (~3 mid-phase architectural-gap micro-cycles per Q-4-A) matches exact mid-phase cycle count at Step 6 (3 of 3). **Two-data-point trajectory:** Phase 3 actual = 5 (projection ~3; over-shoot by 2); Phase 4 actual post-Q-4-Step6-A = 3 (projection ~3; exact match). Phase 4 exit retro deliberation operates on the cumulative trajectory per Q-4-Step6-A Pass 2b data-point-trajectory observation banking. **Conditional Q-4-StepN-B escalation:** if Developer reconnaissance on Q-4-Step5-A.4 surfaces gap OR any Step 7/8/9 architectural-gap surfaces, the counter would over-shoot Q-4-A's projection; trajectory shifts from exact-match toward Phase 3 over-shoot pattern; methodology refinement candidacy strengthens. **If no further escalations:** Phase 4 closes at exact-match; the projection methodology validates at Phase 4 exit retro; strengthens Frame I (intrinsic to phase-specific scope) framing of the multi-gap pattern observation. Either trajectory informs Phase 4 exit retro deliberation cleanly.

### Phase 4 exit retro forward-track candidates (accumulating per Q-4-Step5-A Pass 2b brief confirmation cycle 2026-05-14)

The Phase 4 exit retro candidates surfaced across Phase 4 cycles, accumulating from this cycle:

1. **Cat 9 ritual category candidacy** — forward-tracked at Q-4-Step5-A architect ruling 2026-05-14 (reference-existence-vs-reference-consistency boundary; architect ratification options: (a) ratify Cat 9 addition; (b) defer to v0.2 methodology refinement; (c) maintain status quo + accept reference-consistency gap as bounded-by-implementation-reconnaissance discipline)
2. **Corpus fixture cross-reference field retroactive audit** — forward-tracked at Q-4-Step5-A Pass 2b brief confirmation 2026-05-14 per Required follow-on observation (analogous to Q-3-Step6-A retroactive ritual cycle surface-extension question; should other corpus fixtures carrying `relatedADRs` fields be retroactively audited for ADR-vs-banked-principle conflation per Q-4-Step5-A Pass 2b Banking 3 disambiguation discipline?)
3. **Verbal-pending bankings queue divergence reconciliation** — deferred at Q-4-Step5-A Pass 2b brief confirmation 2026-05-14 per Banking 4 (full-queue audit at Phase 4 exit doc-pass; architect-verbatim-count vs SME-running-count divergence reconciles or persists as bounded operational discipline)
4. **Multi-gap pattern Frame I vs Frame II evaluation** — forward-tracked at Q-4-Step6-A architect ruling 2026-05-14/15 (Phase 4's three substantive-content Steps 4/5/6 each surfaced multi-gap routing-cycle work; pattern: "Step implementation reconnaissance → multi-gap routing-cycle"; Frame I = intrinsic to Phase 4 BFO ARC content scope; Frame II = methodology refinement candidate; architect ratification at retro: (a) confirm Frame I — Phase-4-specific; no methodology change; (b) ratify Frame II + propose methodology refinement — Step-implementation-reconnaissance pre-cycle binding to entry packet + verification ritual category extension + Q-3-E corpus-before-code-vs-step-N-bind threshold refinement; (c) defer further until Phase 5/6 evidence accumulates)
5. **Tight projection-match data point on substantive-scope-weighting methodology** — surfaced at Q-4-Step6-A architect ruling 2026-05-14/15 (Phase 4 substantive-scope-weighting projection at entry ~3 mid-phase architectural-gap micro-cycles per Q-4-A matches exact mid-phase cycle count at Step 6 — 3 of 3; Phase 3 retro candidate #2 forward-track from I5 gains supporting evidence at Phase 4 exit retro)
6. **Cat 10 type-field-structure consistency ritual category candidacy** — forward-tracked at Q-4-Step6-A Pass 2b corrective sub-amendment 2026-05-15 (Cat 5/6/8 verify @type STRING existence but NOT @type FIELD STRUCTURE consistency against canonical interface declarations; SME path-fence-author RBox shape mismatch — `SubObjectPropertyOf` with `subPropertyChain` field instead of canonical top-level `ObjectPropertyChain` per `src/kernel/owl-types.ts:227-231` — surfaced at Developer Pass 2b verification ritual as Catch 6 + Miss 2; structurally analogous to Q-4-Step5-A Cat 9 candidacy reference-existence-vs-reference-consistency boundary; SECOND verification ritual category-expansion candidate evidence-grounded by production miss; architect ratification at retro: (a) ratify Cat 10 addition; (b) defer to v0.2 methodology refinement; (c) maintain status quo + accept type-field-structure gap as bounded-by-complementary-discipline (Developer-side activation-time ritual run))

These three Phase 4-cycle-surfaced candidates join the Phase 3 exit retro forward-tracks inherited at Phase 4 entry per I5:
- Parallel-registry reconciliation (DECISIONS.md ADR-NN ↔ spec §10 ADR-NN) — surfaced again at Q-4-Step5-A as Cat 8 disambiguation requirement; reinforces forward-track urgency
- Substantive-scope-weighting methodology refinement
- Retroactive-ritual-pattern-confirmation (with at-risk-tag-conservatism sub-observation)
- Banking-correction discipline retro analysis
...
### Five new banked principles (architect Q-4-Step4-A mid-phase architectural-gap micro-cycle 2026-05-11; further 5 bankings from Q-4-Step4-A Pass 2b brief confirmation cycle below at next subsection)

Verbatim transcription per the §11 verbatim-transcription discipline. All five bank now (verbally), formalize at Phase 4 EXIT doc-pass alongside the prior cycles' bankings. These bank from the architect's Q-4-Step4-A schema extension ruling cycle (mid-phase architectural-gap micro-cycle first instance for Phase 4); full cycle artifact at `project/reviews/phase-4-step4-disjointness-schema.md`.

1. **ARC schema extensions mirror OWL semantic surfaces where the OWL surface is established; deviation requires explicit architectural justification.** Option A's top-level `disjointnessAxioms` field mirrors OWL's top-level `DisjointClasses` axiom shape; Options B (class-property) and C (separate module) deviate without architectural justification, refused. (Q-4-Step4-A main ruling Option A anchor 1)

2. **Schema shapes that mirror canonical OWL semantic surfaces preserve the OWL-semantic-mirroring anchor through subsequent emitter implementation.** Pairwise-expansion is an emitter implementation choice; the schema preserves the canonical N-ary shape per OWL `DisjointClasses` semantics. The emitter expands N-ary `disjointness({C₁, ..., Cₙ})` to N(N-1)/2 pairwise binary `∀x. Cᵢ(x) ∧ Cⱼ(x) → False` axioms; preserves Horn-checkability per spec §8.5.1. (Q-4-Step4-A.1 banking)

3. **Schema extension scope is bounded by corpus-demanded surfaces; speculative schema fields whose natural surfacing context is a later phase or version defer to that cycle.** Forward-tracking schema fields preserves the corpus-as-contract discipline through the schema-shape surface. DisjointUnion's natural surfacing context (v0.2 ELK closure DL completeness OR future-phase Entity-cover entailment) defers per Q-3-D principle. (Q-4-Step4-A.2 banking)

4. **The standalone routing-cycle artifact pattern generalizes across mid-phase architectural-gap micro-cycles + contingency-operationalization sub-cycles + stakeholder-routing corrective sub-cycles.** Cycle-history standalone artifacts preserve audit trail at micro-cycle granularity regardless of the surface category. The Q-4-C amendment brief-confirmation banking on standalone artifacts (architecturally distinct from per-Step implementation) generalizes cleanly to mid-phase architectural-gap micro-cycles. (Q-4-Step4-A routing artifact banking)

5. **Corpus-shape changes during mid-phase architectural-gap micro-cycles are flagged with explicit count delta + per-item attribution.** Corpus additions follow the same audit-trail discipline as corpus reductions; the symmetric application preserves audit-trail visibility regardless of the change direction. Q-4-Step4-A adds 1 step-N-bind fixture (`bfo_disjointness_map_axiom_emission`); §3.8 corpus-shape-history table per the symmetric corpus-reduction-transparency / corpus-addition-transparency banking. (Q-4-Step4-A corpus addition transparency banking)

These five forward-fold to Phase 4 exit doc-pass; not formalized at Phase 4 entry per architect directive.

### Six new banked principles (architect Q-4-Step5-A mid-phase architectural-gap micro-cycle 2026-05-14)

Verbatim transcription per the §11 verbatim-transcription discipline. All six bank now (verbally), formalize at Phase 4 EXIT doc-pass alongside the prior cycles' bankings. These bank from the architect's Q-4-Step5-A Connected With bridge multi-gap ruling cycle (Phase 4 mid-phase architectural-gap micro-cycle 2/~3; on-projection per Q-4-A); full cycle artifact at `project/reviews/phase-4-step5-connected-with-bridge.md`.
...
5. **Verification ritual category-expansion candidates evidence-grounded by production misses forward-track to phase exit retro candidacy** rather than fresh ratification cycles. Phase exit retro provides phase-cadence methodology-refinement context; speculative category-expansion refused; evidence-grounded category-expansion deferred to retro for full-phase-evidence deliberation. (Meta-observation banking — Cat 9 ritual category candidacy forward-tracked to Phase 4 exit retro)

6. **SME-self-error origins acknowledged in routing artifacts preserve audit-trail honesty.** Error attribution at the path-fence-author surface where the error originated supports cycle accountability discipline. (SME-self-error acknowledgment banking — Q-4-Step5-A surfaced two SME-self-errors from Phase 4 entry-packet authoring: RO_0002170 IRI usage + overlaps→connected_with non-spec-literal requiredPattern; corrections in canary_connected_with_overlap.fixture.js amendment carry audit-trail header per four-contract consistency discipline)

**Complementary observation banking** (from "On the verification ritual's first production miss" section of architect ruling): **The verification ritual's first production miss surfaces the ritual's detection boundary at the reference-existence-vs-reference-consistency layer. Production misses are not discipline failures; they are discipline boundary surfacings that inform methodology refinement candidacy at phase exit retro. Complementary disciplines (Developer-side implementation reconnaissance, stakeholder-routing review) operating alongside the verification ritual produce overlapping coverage; gap surfaces inform refinement.**

These six + complementary observation forward-fold to Phase 4 exit doc-pass; not formalized at Phase 4 entry per architect directive.

### Five new banked principles (architect Q-4-Step5-A Pass 2b brief confirmation cycle 2026-05-14)

Verbatim transcription per the §11 verbatim-transcription discipline. All five bank now (verbally), formalize at Phase 4 EXIT doc-pass alongside the prior cycles' bankings. These bank from the architect's brief Pass 2b confirmation cycle observing the SME's Q-4-Step5-A path-fence-author shape + verification ritual fourth production catch + fixture disambiguation + queue divergence honesty as exemplary practice.

1. **Verification ritual reports' production-history tables enumerate both catches (validation events) and misses (boundary-surfacing events) at the same audit-trail surface.** The dual-enumeration preserves cumulative discipline state visibility; tables that show only catches misrepresent the discipline's operational boundary. Structurally similar to the Phase 3 doc-pass §5 enumeration discipline (withdrawn + preserved + new + meta-banking categories with explicit counts). (Production-catch history table extension banking — surfaced by SME's table extension at `phase-4-step5-connected-with-bridge-verification-ritual-report.md` §5 to include Catch 4 + Miss 1 dual-enumeration)

2. **Verification ritual detection scope expansion accelerates across production catches; later catches operate at higher cross-category granularity than earlier ones.** The expansion pattern is non-linear; each catch validates the ritual's expanding boundary while the misses surface further-expansion candidacy. Trajectory observed: Catches 1-2 single-surface single-category → Catch 3 multi-surface cross-category (Cat 6+8) → Catch 4 multi-surface cross-category at higher granularity (Cat 2+7+8). (Cat 2+7+8 cross-category catch banking — extends Q-4-Step4-A Pass 2b brief confirmation Banking 4 granularity-expansion pattern with non-linear-acceleration sub-observation)

3. **Corpus fixture cross-reference fields for architectural-commitment-tier references disambiguate by surface:** `relatedADRs` for ADR-tier references (numbered, ratified at promotion cycles, stored in `project/DECISIONS.md` or spec §10 ADR registry); `relatedBankedPrinciples` for banked-principle-tier references (verbal-pending until phase exit doc-pass formalization, stored in `arc/AUTHORING_DISCIPLINE.md` post-formalization). Single-field-for-multiple-surfaces invites conflation; the disambiguation discipline preserves through the fixture-cross-reference surface. (Disambiguation discipline banking — surfaced by SME's Catch 4 corrective response in `canary_connected_with_overlap.fixture.js`; pattern generalizes; future fixtures author against the disambiguated shape)

4. **Verbal-pending bankings queue divergences between architect verbatim count and SME running count surface at routing cycles; reconciliation defers to phase exit doc-pass** for full-queue audit. Mid-cycle reconciliation risks recovery-cycle pressure; deferred reconciliation preserves cycle cadence. The 5-count divergence at Q-4-Step5-A (architect 33; SME 38) is bounded; reconciliation cost is bounded; deferring is correct. (Queue divergence deferral banking — honest discipline operation per the SME's commit message acknowledgment + architect Pass 2b confirmation ratification)

5. **Pass 2b commit handoff includes explicit out-of-scope artifact list to prevent accidental inclusion.** Working-tree state with multiple artifact categories (commit-target artifacts + transient build outputs + non-routing-cycle artifacts + Developer-local artifacts) requires explicit scope-boundary acknowledgment to preserve commit hygiene. (Out-of-scope artifact acknowledgment banking, meta-banking — surfaced by SME's explicit `.claude/settings.local.json` + `arc/cco/` + `project/MAREP_v2.1.md` out-of-scope list at Pass 2b commit handoff)

These five forward-fold to Phase 4 exit doc-pass; not formalized at Phase 4 entry per architect directive.

### Six new banked principles (architect Q-4-Step6-A mid-phase architectural-gap micro-cycle 2026-05-14/15)

Verbatim transcription per the §11 verbatim-transcription discipline. All six bank now (verbally), formalize at Phase 4 EXIT doc-pass alongside the prior cycles' bankings. These bank from the architect's Q-4-Step6-A regularityCheck multi-gap ruling cycle (Phase 4 mid-phase architectural-gap micro-cycle 3/3 — HITS Q-4-A ~3 PROJECTION EXACT MATCH); full cycle artifact at `project/reviews/phase-4-step6-regularity-check.md`.
...
2. **SME path-fence-authoring of step-N-bind fixtures is the consistent disposition across Phase 4 mid-phase architectural-gap micro-cycles.** The discipline preserves through the consistent dispatch + verification ritual binding-immediately + Pass 2b brief confirmation pattern. (Q-4-Step6-A.2 consistency banking — three consecutive cycles confirm the pattern)

3. **Mid-phase architectural-gap micro-cycle Pass 2b scope varies by gap shape;** some cycles extend schema (Q-4-Step4-A disjointnessAxioms; Q-4-Step5-A bridgeAxioms), some operate within existing schema (Q-4-Step6-A regularityCheck uses existing owlCharacteristics data). The scope variation reflects the gap-shape diagnosis; uniform Pass 2b scope across cycles is not required. (Q-4-Step6-A.3 scope variation banking)

4. **Step boundaries within phases preserve audit-trail-unity-per-surface** when distinct architectural surfaces ratify at distinct Steps. Conflating surfaces into single Step deliverables corrupts the per-surface ratification discipline; clean separation preserves through Step boundary respect. Step 6 = warning emission control; Step 8 = LossSignature emission + strategy router; clean Q-Step6-1 Phase 2 baseline preservation mirror. (Q-4-Step6-A.4 step boundary banking)

5. **Pattern observations spanning multiple cycles within a phase forward-track to phase exit retro for methodology refinement candidacy.** Mid-cycle pattern interpretation refused; complete-phase evidence + early-next-phase evidence supports clean Frame I (intrinsic to Phase 4 BFO ARC content scope) vs Frame II (methodology refinement candidate) ruling. (Meta-observation banking — Phase 4 multi-gap pattern across Steps 4/5/6 forward-tracks to Phase 4 exit retro)

6. **Non-breaking strengthening of behavioral contracts** (e.g., conditional warning omission preserving Phase 2 unconditional baseline) honors ADR-011 evolution discipline when the strengthening is signal-preserving (omission means strengthened certification) rather than signal-corrupting (omission could mean either certification or implementation gap). (Strengthening framing banking — Step 6 omission semantics: signal-preserving per Q-4-Step6-A.4 + ADR-011)

**Plus tight-projection-match data point banking** (from architect ruling's "On the cycle accounting" section): **Phase 4 substantive-scope-weighting projection at entry (~3 mid-phase architectural-gap micro-cycles) matches exact mid-phase cycle count at Step 6. Tight projection-match validates the methodology at Phase 4; Phase 3 exit retro forward-tracked candidate #2 gains supporting evidence.**

These six + tight-projection-match data point forward-fold to Phase 4 exit doc-pass; not formalized at Phase 4 entry per architect directive.

### Five new banked principles (architect Q-4-Step6-A Pass 2b brief confirmation cycle 2026-05-14/15)

Verbatim transcription per the §11 verbatim-transcription discipline. All five bank now (verbally), formalize at Phase 4 EXIT doc-pass alongside the prior cycles' bankings. These bank from the architect's brief Pass 2b confirmation cycle observing the SME's Q-4-Step6-A path-fence-author shape + Catch 5 disposition + non-linear-acceleration trajectory continuation + tight-projection-match preservation + Phase 4 exit retro candidate accumulation as exemplary practice.

1. **Disciplines ratified at prior cycles operate immediately on subsequent structurally-identical findings without requiring re-routing.** The reuse-without-re-routing pattern validates the discipline's portability across cycles; subsequent instances strengthen the discipline's audit-trail authority. SME applied Q-4-Step5-A Pass 2b Banking 3 disambiguation discipline immediately on Catch 5 (ADR-011 mis-citation, structurally identical to Catch 4 ADR-012 mis-citation); pre-routing correction within SME-domain; no architect re-routing required. (Catch 5 disambiguation reuse banking)

2. **Forward-tracked candidates whose underlying pattern repeats across cycles gain supporting evidence for retro deliberation.** The strengthening discipline preserves through cycle-history accumulation; repeated patterns reach retro with stronger evidence base than singletons. The corpus fixture cross-reference field retroactive audit forward-track candidate (banked at Q-4-Step5-A Pass 2b Banking 3) STRENGTHENED at Q-4-Step6-A by Catch 5 repetition of the same failure-mode-class. (Pattern repetition strengthening banking)

3. **Verification ritual production catch trajectory passes through expansion phases:** scope expansion (single-surface → multi-surface across Catches 1-2 → Catch 3); granularity expansion (Cat 6+8 → Cat 2+7+8 across Catches 3 → 4); **pattern-recognition expansion** (Cat 2+7+8 first instance → Cat 2+7+8 second instance across Catches 4 → 5). Pattern-recognition expansion surfaces when previously-singleton catches recur; the discipline's detection sophistication accumulates per the pattern-recognition surface. (Trajectory pattern banking)

4. **Substantive-scope-weighting projection accuracy data points are preserved at the cycle where the projection is satisfied** (exact match, over-shoot, or under-shoot). The data points accumulate for phase exit retro methodology refinement deliberation; preservation at cycle-of-occurrence prevents data-point loss between cycle and retro. Phase 3 actual mid-phase counter: 5 (projection ~3; over-shoot by 2). Phase 4 actual mid-phase counter post-Q-4-Step6-A: 3 (projection ~3; exact match). Two-data-point evidence accumulates for Phase 4 exit retro deliberation. (Projection-match data-point preservation banking)

5. **Phase exit retro candidates list accumulation across cycles validates the forward-track-to-retro discipline.** Mid-phase candidate counts preserve the discipline's operational integrity; retro deliberation operates on full-phase candidate evidence. Phase 4 exit retro candidate count at this cycle: 5 (Cat 9 + corpus fixture cross-reference audit STRENGTHENED + queue divergence reconciliation + multi-gap pattern Frame I vs Frame II + tight-projection-match data point). (Candidate accumulation meta-banking)

**Plus data-point-trajectory observation banking** (from architect ruling's "On the tight-projection-match data point" section): **Substantive-scope-weighting projection accuracy varies across phases; one Phase-3 over-shoot + one Phase-4 exact-match constitutes two-data-point evidence. Phase 4 exit retro deliberation operates on the cumulative trajectory; methodology refinement candidacy strengthens or weakens per the trajectory pattern.**

These five + data-point-trajectory observation forward-fold to Phase 4 exit doc-pass; not formalized at Phase 4 entry per architect directive.

### Five new banked principles (architect Q-4-Step4-A Pass 2b brief confirmation cycle 2026-05-14)

Verbatim transcription per the §11 verbatim-transcription discipline. All five bank now (verbally), formalize at Phase 4 EXIT doc-pass alongside the prior cycles' bankings. These bank from the architect's brief Pass 2b confirmation cycle observing the SME's Q-4-Step4-A path-fence-author shape + verification ritual production catch + cumulative cycle history as exemplary practice.

1. **Verification ritual cross-category production catches surface enumeration errors at IRI-reuse-across-semantically-distinct-classes surfaces by comparing cross-reference consistency.** Multi-surface comparison extends the ritual's detection scope beyond single-surface verification. (Q-4-Step4-A Pass 2b confirmation cycle Cat 6 + Cat 8 cross-category catch banking — this engagement's first multi-surface cross-reference catch; single-surface catches verify each surface independently; multi-surface catches verify cross-reference consistency across surfaces.)

2. **Verification ritual production catches at canonical-source-reference surfaces disposition into pre-routing correction (SME-domain mechanical fix) + `[VERIFY]` marker deferral for canonical-value flip at vendoring time (Developer-domain at Pass 2b commit).** The two-part disposition preserves both the audit-trail discipline and the canonical-source vendoring-time discipline. (Pre-routing correction + `[VERIFY]` marker deferral banking; mirrors ADR-010 license-verification-at-vendoring-time discipline + Q-4-C amendment Cat 8 vendoring-time-deferral precedent)

3. **Phase entry packets carrying multi-cycle audit-trail accumulate dedicated cycle history tables at the corpus-shape surface.** The table preserves shape evolution at micro-cycle granularity beyond the §11 Q-rulings verbatim transcription, providing an alternative reader-entry-point for cycle-history audit traversal. (§3.8 cycle history table banking; surfaced by the SME's §3.8 amendment at Q-4-Step4-A capturing the Phase 4 corpus-shape evolution from initial DRAFT through Q-4-C amendment cycle through Q-4-Step4-A schema extension)

4. **Verification ritual detection scope expands as ritual run history accumulates production catches; cross-category multi-surface catches surface enumeration errors that single-surface category checks cannot detect alone.** The discipline operates at increasing granularity as the ritual's run history accumulates. (Granularity-expansion pattern banking; surfaced by the three-catch cumulative discipline-validation: Phase 3 Step 5 single-surface Cat 6 → Q-4-C amendment single-surface Cat 5 → Q-4-Step4-A cross-category Cat 6 + Cat 8)

5. **Verbal-pending bankings queues accumulate across mid-phase cycles + entry-cycle cycles + contingency-operationalization sub-cycles + stakeholder-routing corrective sub-cycles between phase exit doc-pass formalizations.** Queue size correlates with phase substantive scope; the Phase 4 substantive-scope-weighting projection of ~3 mid-phase architectural-gap micro-cycles + Phase 4's other cycle categories sets queue-size expectations of ~30+ at Phase 4 exit doc-pass. (Queue-size-correlates-with-phase-substantive-scope pattern banking; observed at Q-4-Step4-A Pass 2b confirmation cycle — queue at 32 entries this cycle aligns with architect-projected ~30+ at Phase 4 exit)

These five forward-fold to Phase 4 exit doc-pass; not formalized at Phase 4 entry per architect directive.

### Banking accounting summary (post-Q-4-Step4-A-Pass-2b-brief-confirmation 2026-05-14)
...
- 5 from Q-4-Step4-A mid-phase architectural-gap micro-cycle (2026-05-11) — ARC schema OWL-mirroring + N-ary schema preservation through emitter + schema scope corpus-bounded + routing artifact discipline generalization + corpus-addition-transparency symmetric application
- 5 from Q-4-Step4-A Pass 2b brief confirmation cycle (2026-05-14) — cross-category production catch + pre-routing correction + [VERIFY] marker deferral + cycle history table + granularity-expansion pattern + queue-size-correlates-with-phase-substantive-scope pattern
- 6 from Q-4-Step5-A mid-phase architectural-gap micro-cycle (2026-05-14) — fixture-vs-spec-ratification alignment + four-anchor schema-extension pattern generalization + discriminated-union-with-enum schema shape + Developer-reconnaissance-first mid-phase scope decision + verification ritual category-expansion forward-track to phase exit retro + SME-self-error acknowledgment + complementary verification-ritual-first-production-miss observation banking
- 5 from Q-4-Step5-A Pass 2b brief confirmation cycle (2026-05-14) — production-catch history table extension + Cat 2+7+8 cross-category catch with non-linear-acceleration pattern + corpus fixture cross-reference field disambiguation discipline (relatedADRs vs relatedBankedPrinciples) + verbal-pending bankings queue divergence deferral + out-of-scope artifact acknowledgment meta-banking
- 6 from Q-4-Step6-A mid-phase architectural-gap micro-cycle (2026-05-14/15) — minimum-viable transitivity certification + step-N-bind authoring consistency + Pass 2b scope variation + step boundary preservation + multi-gap pattern forward-track to Phase 4 exit retro + non-breaking signal-preserving strengthening; plus tight-projection-match data point banking (Phase 4 mid-phase counter hits Q-4-A ~3 projection EXACT MATCH at Step 6)
- **5 from Q-4-Step6-A Pass 2b brief confirmation cycle (2026-05-14/15) — Catch 5 disambiguation reuse + pattern repetition strengthening + production catch trajectory pattern-recognition-expansion + projection-match data-point preservation + candidate accumulation meta-banking; plus data-point-trajectory observation banking (Phase 3 over-shoot + Phase 4 exact-match two-data-point evidence)**
...
**Total Phase 4 exit doc-pass formalization queue per architect Q-4-Step6-A Pass 2b brief confirmation cycle 2026-05-14/15 (continuing verbatim count): architect verbatim count adds 5 = 44; SME internal running count adds 5 = 49. The 5-count divergence persists at this cycle.** Per Q-4-Step5-A Pass 2b brief confirmation Banking 4 (queue divergence deferral banking): the architect-verbatim-count vs SME-running-count divergence is honest discipline operation; reconciliation defers to Phase 4 exit doc-pass for full-queue audit. Bankings stratify by sub-cycle origin per the cycle-stratification discipline banked at Phase 3 doc-pass; AUTHORING_DISCIPLINE.md fold-in at Phase 4 Step 9.5 per the amended Step 9 sub-step framing.

**Architect-noted sub-divergence vector** (per Q-4-Step6-A brief confirmation "On the cycle accounting" section): the architect's count of 5 new bankings this brief-confirmation cycle vs the SME's reported 6 in the Q-4-Step6-A commit message creates a potential secondary divergence vector. Resolution: the SME's "6" referenced the Q-4-Step6-A architect-ruling cycle's bankings (1-6 from the prior ruling text); this brief-confirmation cycle's bankings are the new 5 (per architect verbatim). The Q-4-Step6-A architect-ruling cycle's 6 bankings were folded earlier at §12 (this packet) — the count reconciles cleanly at the running total when stratified by sub-cycle origin. Sub-divergence reconciliation defers to Phase 4 exit doc-pass per the established deferral banking.
...
- **`project/reviews/phase-4-step4-disjointness-schema.md` — Q-4-Step4-A mid-phase architectural-gap micro-cycle routing artifact 2026-05-11 (FIRST instance of Phase 4 mid-phase architectural-gap counter; ARC schema extension authorizing `disjointnessAxioms` field on `ARCModule` per Q-4-Step4-A Option A + N-ary semantics + simple disjointness only + `disjointnessAxioms` field naming; 5 new banked principles)**
- **`project/reviews/phase-4-step5-connected-with-bridge.md` — Q-4-Step5-A mid-phase architectural-gap micro-cycle routing artifact 2026-05-14 (SECOND instance of Phase 4 mid-phase architectural-gap counter; on-projection per Q-4-A; four-gap finding: ARC content gap + ARC schema gap + spec-vs-fixture axiom shape discrepancy + IRI discrepancy; ARC schema extension authorizing `bridgeAxioms` field on `ARCModule` per Q-4-Step5-A.2 Option A + discriminated-union with axiomForm enum per Q-4-Step5-A.2.1; canary_connected_with_overlap fixture amendment per spec-literal alignment + cco:ont00001810 IRI swap per Q-4-Step5-A.3; verification ritual FIRST PRODUCTION MISS surfaced + Cat 9 ritual category candidacy forward-tracked to Phase 4 exit retro; 6 new banked principles + complementary observation banking)**
- **`project/reviews/phase-4-step6-regularity-check.md` — Q-4-Step6-A mid-phase architectural-gap micro-cycle routing artifact 2026-05-14/15 (THIRD instance of Phase 4 mid-phase architectural-gap counter; HITS Q-4-A ~3 PROJECTION EXACT MATCH; four-gap finding: algorithm scope ambiguity + corpus content gap + ARC content sparseness + Step 6 / Step 8 boundary; Reading 3 hybrid + Sub-option α non-transitive chain certification per Horrocks et al. 2007 — minimum-viable certification using existing BFO catalogue's owlCharacteristics data with no ARC schema extension; full SROIQ Horrocks regularity check forward-tracked to v0.2 ELK closure per v0.2-09 new entry; multi-gap pattern observation across Phase 4 Steps 4/5/6 forward-tracks to Phase 4 exit retro Frame I vs Frame II evaluation; 6 new banked principles + tight-projection-match data point banking)**
...
**[STATUS UPDATE 2026-05-10]** Phase 4 entry packet AMENDED + RATIFIED at architect initial-review + final-ratification cycles 2026-05-10. **[STATUS UPDATE 2026-05-10 — Q-4-C source-state amendment cycle]** Further AMENDED at Q-4-C source-state amendment cycle 2026-05-10 per architect Ruling 3 amendment table — sections §1, §2.10, §3.2, §3.4, §3.5, §3.7, §3.8, §6.1 (NEW), §7, §8.2, §9, §11 Q-4-C, §12, §13 amended. Layer B vendoring + `p4_bfo_clif_layer_b` forward-tracked to Phase 5 per §6.1 inheritance manifest; 7 new banked principles forward-fold to Phase 4 exit doc-pass per §12. Pass 2a contents revised (4 corpus-before-code fixtures; Layer B vendoring artifacts pulled). **[STATUS UPDATE 2026-05-10 — Q-4-C amendment brief confirmation cycle]** Architect brief confirmation ISSUED 2026-05-10 on the Q-4-C amendment artifact set: 6 modified artifacts verified against the four rulings + seven banked principles; 3 new banked principles from the brief confirmation cycle (sidecar SHELL preservation + re-run report discipline + standalone routing-cycle artifact) appended to §12 verbal-pending. **Phase 4 contingency-operationalization sub-cycle CLOSED at brief confirmation cycle**; formalization at Pass 2a commit lands + remote CI green (landed at commit `1f2cff6` 2026-05-10). Pass 2a UNBLOCKED for developer commit per architect-ratified 8-artifact set; Phase 4 Step 1 begins after Pass 2a commit + CI green verification. **[STATUS UPDATE 2026-05-11 — Q-4-Step4-A mid-phase architectural-gap micro-cycle]** Phase 4 Step 4 implementation surfaced load-bearing schema gap in entry packet §2.3 commitment; architect Q-4-Step4-A ruling 2026-05-11 ratified Option A (`disjointnessAxioms` field) + N-ary semantics + simple disjointness only + `disjointnessAxioms` field naming + canonical-sources sub-ruling + routing-artifact discipline + 5 banked principles. SME path-fence-author + verification ritual produced 6 Pass 2b artifacts (3 new + 3 modified; first cross-category Cat 6 + Cat 8 production catch on ContinuantFiatBoundary IRI conflation surfaced + corrected pre-routing per binding-immediately discipline). **[STATUS UPDATE 2026-05-14 — Q-4-Step4-A Pass 2b brief confirmation cycle]** Architect brief confirmation ISSUED 2026-05-14 on Pass 2b artifact set: 6 correspondence checks pass; 5 new banked principles appended (cross-category catch + pre-routing correction + [VERIFY] deferral + cycle history table + granularity-expansion + queue-size-correlates-with-substantive-scope). **Phase 4 mid-phase architectural-gap sub-cycle CLOSED at brief confirmation**; formalization at Pass 2b commit + remote CI green (landed at commit `427eff5`). Pass 2b UNBLOCKED for developer commit per architect-ratified 6-artifact set + Developer-side implementation work + `[VERIFY]` marker flip from canonical bfo-2020.owl fetch. **[STATUS UPDATE 2026-05-14 — Q-4-Step5-A mid-phase architectural-gap micro-cycle SECOND instance]** Phase 4 Step 5 implementation reconnaissance surfaced four-gap finding; architect Q-4-Step5-A ruling 2026-05-14 ratified Option (d) spec-literal + fixture amendment + Option A bridgeAxioms field + discriminated-union with axiomForm enum + cco:ont00001810 spec-literal IRI + Developer reconnaissance defer + Cat 9 ritual category candidacy forward-track to Phase 4 exit retro + 6 banked principles + complementary observation banking. SME path-fence-author + verification ritual on path-fence-authored artifacts pre-routing per binding-immediately discipline. Verification ritual FIRST PRODUCTION MISS surfaced (Q-4-G phase-boundary retroactive batch 2026-05-10 reported 0 Cat 7 findings on `canary_connected_with_overlap` but reference-existence-vs-reference-consistency boundary not in current ritual category coverage; Cat 9 candidacy forward-tracked to Phase 4 exit retro). Phase 4 mid-phase architectural-gap counter increments 1 → 2 (on-projection per Q-4-A's ~3 mid-phase cycles). **[STATUS UPDATE 2026-05-14 — Q-4-Step5-A Pass 2b brief confirmation cycle]** Architect brief Pass 2b confirmation ISSUED 2026-05-14 on Q-4-Step5-A artifact set: 7 correspondence checks pass (2 new + 5 modified); 5 new banked principles appended (production-catch history table extension + Cat 2+7+8 cross-category non-linear-acceleration + corpus fixture cross-reference field disambiguation + queue divergence deferral + out-of-scope artifact acknowledgment meta-banking). Verification ritual's FOURTH PRODUCTION CATCH (Cat 2+7+8 cross-category — ADR-registry/banked-principle conflation in fixture's relatedADRs corrected pre-routing) banked at Pass 2b confirmation Banking 2. **Phase 4 mid-phase architectural-gap sub-cycle CLOSED at brief confirmation**; formalization at Pass 2b commit + remote CI green. Pass 2b UNBLOCKED for developer commit per architect-ratified 7-artifact set + Developer-side implementation work + Developer reconnaissance on Phase 1 emitter handling of owl:SymmetricProperty + owl:ReflexiveProperty for cco:ont00001810 + `[VERIFY]` marker flip from canonical CCO source fetch. Phase 4 verbal-pending bankings queue per architect verbatim continuing: 33 + 5 = **38 entries** (SME running 38 + 5 = 43; queue divergence persists per Q-4-Step5-A Pass 2b Banking 4 deferral). Three new Phase 4 exit retro forward-track candidates accumulating (Cat 9 ritual category + corpus fixture cross-reference field retroactive audit + verbal-pending bankings queue divergence reconciliation). **[STATUS UPDATE 2026-05-14/15 — Q-4-Step6-A mid-phase architectural-gap micro-cycle THIRD instance — HITS Q-4-A ~3 PROJECTION EXACT MATCH]** Phase 4 Step 6 implementation reconnaissance surfaced four-gap finding; architect Q-4-Step6-A ruling 2026-05-14/15 ratified Reading 3 hybrid + Sub-option α non-transitive chain certification per Horrocks et al. 2007 + SME dispatch + full SROIQ forward-track to v0.2 (v0.2-09) + Step 6 = warning emission control only + 6 banked principles + tight-projection-match data point banking + multi-gap pattern observation forward-track to Phase 4 exit retro. SME path-fence-author + verification ritual on path-fence-authored artifacts pre-routing. **NO ARC schema extension at this cycle** per Q-4-Step6-A.3 forward-track ruling. Phase 4 mid-phase architectural-gap counter increments 2 → 3 (Q-4-A ~3 projection EXACT MATCH). Phase 4 verbal-pending bankings queue per architect verbatim continuing: 38 + 6 = **39 entries** (architect verbatim) / 43 + 6 = **44 entries** (SME running). FIVE Phase 4 exit retro forward-track candidates accumulated. **[STATUS UPDATE 2026-05-14/15 — Q-4-Step6-A Pass 2b brief confirmation cycle]** Architect brief Pass 2b confirmation ISSUED 2026-05-14/15 on Q-4-Step6-A artifact set: 7 correspondence checks pass (4 new + 3 modified); 5 new banked principles appended (Catch 5 disambiguation reuse + pattern repetition strengthening + production catch trajectory pattern-recognition-expansion + projection-match data-point preservation + candidate accumulation meta-banking; plus data-point-trajectory observation banking). Verification ritual's FIFTH PRODUCTION CATCH (Cat 2+7+8 cross-category — ADR-011 mis-citation; SECOND instance of parallel-registry-conflation pattern after Q-4-Step5-A Catch 4 ADR-012) banked at Pass 2b confirmation Banking 1 (Catch 5 disambiguation reuse — discipline ratified at prior cycle operated immediately on this cycle's structurally-identical finding). **Phase 4 mid-phase architectural-gap sub-cycle CLOSED at brief confirmation**; formalization at Pass 2b commit + remote CI green. Pass 2b UNBLOCKED for developer commit per architect-ratified 7-artifact set + Developer-side implementation work (NEW kernel function regularityCheck + projector amendment + FolToOwlConfig extension + Dev-side activation test). Phase 4 verbal-pending bankings queue per architect verbatim continuing: 39 + 5 = **44 entries** (architect verbatim) / 44 + 5 = **49 entries** (SME running; divergence persists per Banking 4 deferral). Architect-noted sub-divergence on this brief-confirmation cycle's banking count (5 architect / 6 SME commit-message): reconciles cleanly per sub-cycle stratification; the SME's "6" referenced Q-4-Step6-A architect-ruling bankings 1-6 (folded earlier at §12). FIVE Phase 4 exit retro forward-track candidates accumulated (Cat 9 + corpus fixture cross-reference audit STRENGTHENED + queue divergence reconciliation + multi-gap pattern Frame I vs Frame II + tight-projection-match data point); cumulative two-data-point trajectory on substantive-scope-weighting (Phase 3 over-shoot 5/~3 + Phase 4 exact-match 3/~3). **[STATUS UPDATE 2026-05-15 — Q-4-Step6-A Pass 2b corrective sub-amendment]** Developer Pass 2b verification ritual 2026-05-15 surfaced Cat 8 production catch on both step-N-bind fixtures' RBox shape (SME path-fence-author error 2026-05-14: used `SubObjectPropertyOf` with `subPropertyChain: { properties: [...] }` field instead of canonical top-level `ObjectPropertyChain` per `src/kernel/owl-types.ts:227-231`); both fixtures threw `IRIFormatError` at lift time blocking determinism harness + Step 6 activation tests. **Pre-routing correction within open Pass 2b window** per binding-immediately discipline + Q-4-Step6-A Pass 2b Banking 1 (Catch 5 disambiguation reuse — disciplines ratified at prior cycles operate immediately on subsequent findings without re-routing; here generalizes from ADR-registry-conflation to type-field-structure-conflation). Both fixtures' RBox amended to canonical `ObjectPropertyChain` shape; audit-trail headers updated with corrective-sub-amendment entry. **Verification ritual SIXTH production catch (Catch 6) + SECOND production miss (Miss 2)** banked at this corrective sub-amendment: Catch 6 = Developer Pass 2b ritual catch on Cat 5/6/8 type-field-structure-mismatch boundary; Miss 2 = SME pre-routing ritual @type-existence-vs-@type-field-structure-consistency boundary surfacing (mirrors Q-4-Step5-A Miss 1 reference-existence-vs-reference-consistency pattern). **SIXTH Phase 4 exit retro forward-track candidate added: Cat 10 type-field-structure consistency ritual category candidacy** — SECOND verification ritual category-expansion candidate evidence-grounded by production miss; structurally analogous to Cat 9 candidacy. SME-domain mechanical fix; no architect re-routing required. Pass 2b commit unblocked post-corrective-amendment per architect-ratified sequencing; Developer-side chain-detection investigation continues at Step 6 activation follow-up (Developer-domain). Phase 4 verbal-pending bankings queue continues at 44 (architect verbatim) / 49 (SME running); the corrective sub-amendment introduces verbal-banking observations (cadence-distinct-complementary-discipline pattern + Cat 10 candidacy framing) which fold to Phase 4 exit doc-pass per established pattern.
